        ...
        <div class="notice base47-fallback-notice">
            ...
            <div class="base47-fallback-content">
                ...
                <div class="base47-fallback-actions">
                    <a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=base47-he-settings&action=deactivate_fallback' ), 'base47_deactivate_fallback' ) ); ?>" 
                    ...
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-logs' ) ); ?>" 
...
add_action( 'admin_init', function() {
    ...
    if ( ! isset( $_GET['action'] ) || $_GET['action'] !== 'deactivate_fallback' ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
        return;
    }
    
    if ( ! isset( $_GET['page'] ) || $_GET['page'] !== 'base47-he-settings' ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
        return;
    }
    ...
    // Verify nonce
    if ( ! isset( $_GET['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_wpnonce'] ) ), 'base47_deactivate_fallback' ) ) {
        wp_die( esc_html__( 'Security check failed.', 'base47-html-editor' ) );
    }
    
    Base47_Fallback_Mode::deactivate();
    
    // Redirect back to dashboard instead of settings
    wp_safe_redirect( admin_url( 'admin.php?page=base47-he-dashboard&fallback_deactivated=1' ) );
    exit;
});
