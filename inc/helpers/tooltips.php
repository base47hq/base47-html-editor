...
function base47_he_get_all_tooltips() {
    return [
        ...
        'dashboard_stats' => [
            ...
            'help_box' => '<p>These statistics give you a quick overview of your Arq Editor setup:</p>
                          <ul>
...
└── assets/
    ...
    └── js/</pre>
        ...
        'settings_asset_loading' => [
            'title' => 'Asset Loading',
            'content' => 'Configure how template assets are loaded and optimized.',
            'help_box' => '<p>Asset loading options:</p>
                          <ul>
                            <li>Base47 Loader: Standard asset loading (Free)</li>
                            <li>Manifest Loader: JSON-based asset management (Free)</li>
                            <li>Smart Loader++: Advanced optimization (Pro)</li>
                          </ul>'
        ],
        ...
        'license_key' => [
            'title' => 'License Key',
            'content' => 'Enter your Arq Editor Pro license key to unlock premium features.',
        ],
...
└── assets/
    ...
    └── js/main.js</pre>
        ...
        'settings' => [
            ...
            'content' => '
                <h3>Settings</h3>
                <p>Configure Arq Editor options and performance settings.</p>
                ...
                <ul>
                    <li><strong>Asset Loading:</strong> Configure asset optimization</li>
