        ...
        <div class="base47-onboarding-container">
            ...
            <div class="onboarding-header">
                <div class="logo-section">
                    <img src="<?php echo esc_url( BASE47_HE_URL . 'admin-assets/images/base47-logo.svg' ); ?>" alt="Base47 HTML Editor" class="onboarding-logo">
                ...
                <div class="progress-bar">
                    ...
                    <div class="progress-line">
                        <div class="progress-fill" style="width: <?php echo esc_attr( ( ( $current_step - 1 ) / 4 ) * 100 ); ?>%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="onboarding-navigation">
                <?php if ( $current_step > 1 ) : ?>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-onboarding&step=' . ( $current_step - 1 ) ) ); ?>" class="button button-secondary">
                ...
                <?php if ( $current_step < 5 ) : ?>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-onboarding&step=' . ( $current_step + 1 ) ) ); ?>" class="button button-primary">
                        Next
                        <span class="dashicons dashicons-arrow-right-alt2"></span>
                    </a>
                <?php endif; ?>
                
                <a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=base47-he-dashboard&dismiss_onboarding=1' ), 'base47_dismiss_onboarding' ) ); ?>" class="button button-link skip-onboarding">
                    Skip Tour
                </a>
            </div>
        </div>
        ...
        <div class="step-content">
            ...
            <div class="version-info">
                <div class="version-badge">
                    ...
                    <span class="version-number"><?php echo esc_html( BASE47_HE_VERSION ); ?></span>
                </div>
            ...
            <div class="step-instructions">
                <div class="instruction-card">
                    ...
                    <div class="instruction-content">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-marketplace' ) ); ?>" class="instruction-button" target="_blank">
            ...
            <div class="step-instructions">
                <div class="instruction-card">
                    ...
                    <div class="instruction-content">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-theme-manager' ) ); ?>" class="instruction-button" target="_blank">
                            <span class="dashicons dashicons-external"></span>
                            Open Theme Manager
                        </a>
                    </div>
            ...
            <div class="step-instructions">
                <div class="instruction-card">
                    ...
                    <div class="instruction-content">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-editor' ) ); ?>" class="instruction-button" target="_blank">
                            <span class="dashicons dashicons-external"></span>
                            Open Live Editor
                        </a>
                    </div>
                ...
                <div class="instruction-card">
                    ...
                    <div class="instruction-content">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-templates' ) ); ?>" class="instruction-button" target="_blank">
                            <span class="dashicons dashicons-external"></span>
                            View Shortcodes
                        </a>
                ...
                <div class="instruction-card">
                    ...
                    <div class="instruction-content">
                        ...
                        <a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=page' ) ); ?>" class="instruction-button" target="_blank">
                            <span class="dashicons dashicons-external"></span>
                            Create New Page
                        </a>
                    </div>
        ...
        <div class="step-content">
            ...
            <div class="next-steps">
                ...
                <div class="steps-grid">
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-editor' ) ); ?>" class="next-step-card">
                        <div class="step-icon">
                    ...
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-marketplace' ) ); ?>" class="next-step-card">
                        <div class="step-icon">
                    ...
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-dashboard' ) ); ?>" class="next-step-card">
                        <div class="step-icon">
            ...
            <div class="completion-actions">
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-dashboard' ) ); ?>" class="button button-primary button-hero">
                    Go to Dashboard
                    <span class="dashicons dashicons-arrow-right-alt2"></span>
                </a>
                ...
                <div class="social-follow">
                    ...
                    <div class="social-links">
                        <a href="https://www.instagram.com/base47.app/" target="_blank" class="social-link">
                            <span class="dashicons dashicons-instagram"></span>
                        </a>
                        <a href="https://base47.art/blog/" target="_blank" class="social-link">
