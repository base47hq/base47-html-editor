...
function base47_he_theme_manager_page() {
    ...
    <div class="wrap base47-he-wrap base47-tm-soft-ui">
        ...
        <?php base47_he_render_header_nav( 'themes', 'Manage your theme collections' ); ?>
        </div>
        ...
        <!-- Pro Features Notice -->
        <?php do_action( 'base47_he_theme_manager_notices' ); ?>
        
        <div class="pro-notice-content">
            <h4>1 Template Pack (Free Version)</h4>
            <p>The free version includes <strong>1 template pack</strong>. The Pro add-on provides <strong>unlimited template packs</strong> and access to the Base47 Template Marketplace.</p>
...
function base47_he_render_theme_manager_section() {
    ...
    <div class="base47-tm-grid-soft">
        <?php foreach ( $themes as $slug => $theme ) :
            ...
            $use_smart    = false; // Free version - no Smart Loader
            ...
            <div class="base47-tm-card-body">
                ...
                <div class="base47-tm-asset-modes">
                    ...
                    <div class="base47-tm-mode-options">
                        ...
                        <!-- Pro Asset Loaders -->
                        <?php do_action( 'base47_he_theme_asset_loaders', $slug, $theme ); ?>
                    </div>

                    <!-- Pro Asset Loader Fields -->
                    <?php do_action( 'base47_he_theme_asset_loader_fields', $slug, $theme ); ?>
                </div>
