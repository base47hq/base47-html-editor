...
function base47_he_support_page() {
    ...
    $ticket_id = isset( $_GET['ticket'] ) ? absint( $_GET['ticket'] ) : null; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
...
function base47_he_support_tickets_list() {
    ...
    <div class="wrap base47-support-system">
        ...
        <?php
        $support_header_btns = '<a href="' . esc_url( admin_url( 'admin.php?page=base47-he-support&action=new' ) ) . '" class="b47-btn b47-btn-primary b47-btn-sm"><span class="dashicons dashicons-plus-alt" style="font-size:16px;width:16px;height:16px;"></span> New Ticket</a>';
        base47_he_render_header_nav( 'support', 'Get help from our expert support team', $support_header_btns );
        ?>
        </div>
        
        <!-- Header (replaced by b47 header above) -->
        ...
        <div class="support-stats-grid">
            ...
            <div class="support-stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo esc_html( base47_he_count_tickets_by_status( $tickets, 'open' ) ); ?></div>
            ...
            <div class="support-stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo esc_html( base47_he_count_tickets_by_status( $tickets, 'in_progress' ) ); ?></div>
            ...
            <div class="support-stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo esc_html( base47_he_count_tickets_by_status( $tickets, 'resolved' ) ); ?></div>
            ...
            <div class="quick-help-grid">
                <div class="help-item">
                    ...
                    <div class="help-content">
                        ...
                        <a href="https://base47.art/docs/" target="_blank" class="help-link">Browse Docs →</a>
                    </div>
                </div>
                ...
                <div class="help-item">
                    ...
                    <div class="help-content">
                        ...
                        <a href="https://base47.art/tutorials/" target="_blank" class="help-link">Watch Videos →</a>
                    </div>
                </div>
                ...
                <div class="help-item">
                    ...
                    <div class="help-content">
                        ...
                        <a href="https://base47.art/forum/" target="_blank" class="help-link">Join Forum →</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tickets-section">
            ...
            <?php if ( empty( $tickets ) ) : ?>
                <div class="no-tickets">
                    ...
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-support&action=new' ) ); ?>" class="button button-primary">
                        ...
                        <div class="ticket-item" data-status="<?php echo esc_attr( $ticket['status'] ); ?>">
                            <div class="ticket-status">
                                <span class="status-badge status-<?php echo esc_attr( $ticket['status'] ); ?>">
                                    <?php echo esc_html( base47_he_get_status_label( $ticket['status'] ) ); ?>
                                </span>
                            </div>
                            ...
                            <div class="ticket-content">
                                <div class="ticket-header">
                                    <h3 class="ticket-title">
                                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-support&action=view&ticket=' . $ticket['id'] ) ); ?>">
                                ...
                                <div class="ticket-footer">
                                    <div class="ticket-date">
                                        Created: <?php echo esc_html( gmdate( 'M j, Y \a\t g:i A', strtotime( $ticket['created_at'] ) ) ); ?>
                                    </div>
                                    <div class="ticket-actions">
                                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-support&action=view&ticket=' . $ticket['id'] ) ); ?>" class="ticket-action-btn">
                                            View Details
                                        </a>
...
function base47_he_support_new_ticket_form() {
    ...
    <div class="wrap base47-support-new-ticket">
        <div class="b47-wrap" style="padding-bottom:0;">
        <?php base47_he_render_header_nav( 'support', 'Create a new support ticket' ); ?>
        </div>
        ...
        <div class="support-header">
            ...
            <div class="header-actions">
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-support' ) ); ?>" class="button">
        ...
        <div class="ticket-form-container">
            <form id="new-support-ticket-form" class="ticket-form">
                ...
                <div id="system-info-preview" class="system-info-section">
                    ...
                    <div class="system-info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo esc_html( BASE47_HE_VERSION ); ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Active Theme:</span>
                            <span class="info-value"><?php echo esc_html( wp_get_theme()->get( 'Name' ) ); ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Server:</span>
                            <span class="info-value"><?php echo esc_html( isset( $_SERVER['SERVER_SOFTWARE'] ) ? sanitize_text_field( wp_unslash( $_SERVER['SERVER_SOFTWARE'] ) ) : 'Unknown' ); ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">User Agent:</span>
                            <span class="info-value"><?php echo esc_html( isset( $_SERVER['HTTP_USER_AGENT'] ) ? sanitize_text_field( wp_unslash( $_SERVER['HTTP_USER_AGENT'] ) ) : 'Unknown' ); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=base47-he-support' ) ); ?>" class="button button-large">
                        Cancel
                    </a>
                </div>
...
function base47_he_support_view_ticket( $ticket_id ) {
    if ( ! $ticket_id ) {
        wp_safe_redirect( admin_url( 'admin.php?page=base47-he-support' ) );
        exit;
    }
    ...
    <div class="wrap base47-support-ticket-view">
        <div class="b47-wrap" style="padding-bottom:0;">
        <?php base47_he_render_header_nav( 'support', 'View support ticket' ); ?>
        </div>
            ...
            <div class="header-content">
                ...
                <div class="ticket-meta-header">
                    ...
                    <span class="priority-badge priority-<?php echo esc_attr( $ticket['priority'] ); ?>">
                        <?php echo esc_html( ucfirst( $ticket['priority'] ) ); ?> Priority
                    </span>
            ...
            <div class="message-item message-user">
                <div class="message-header">
                    ...
                    <div class="message-date">
                        <?php echo esc_html( gmdate( 'M j, Y \a\t g:i A', strtotime( $ticket['created_at'] ) ) ); ?>
                    </div>
                </div>
            ...
            <?php foreach ( $replies as $reply ) : ?>
                <div class="message-item message-<?php echo esc_attr( $reply['author_type'] ); ?>">
                    <div class="message-header">
                        ...
                        <div class="message-date">
                            <?php echo esc_html( gmdate( 'M j, Y \a\t g:i A', strtotime( $reply['created_at'] ) ) ); ?>
                        </div>
                    </div>
                    <div class="message-content">
...
function base47_he_get_support_tickets() {
    ...
    // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, PluginCheck.Security.DirectDB.UnescapedDBParameter -- Admin-only custom support table. Table name is built from $wpdb->prefix and a hardcoded suffix.
    $tickets = $wpdb->get_results( $wpdb->prepare(
        // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- Table name is built from $wpdb->prefix and a hardcoded suffix. Query values are prepared.
